<?php $__env->startSection('content'); ?>
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="<?php echo e(route('user.update', $user)); ?>" autocomplete="off" class="form-horizontal">
            <?php echo csrf_field(); ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="name" id="input-name" type="text" placeholder="<?php echo e(__('Nome')); ?>" value="<?php echo e(old('name', $user->name)); ?>" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?>">
                      <input class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" input type="password" name="password" id="input-password" placeholder="<?php echo e(__('Password')); ?>" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="password_confirmation" id="input-password-confirmation" type="password" placeholder="<?php echo e(__('Confirmar Password')); ?>" />
                    </div>
                  </div>
                </div>
              </div>
...
Aqui você pode gerenciar usuários')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/escola.final/resources/views/users/edit.blade.php ENDPATH**/ ?>