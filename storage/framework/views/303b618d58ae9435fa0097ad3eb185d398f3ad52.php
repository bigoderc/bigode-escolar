      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item<?php echo e($activePage == 'login' ? ' active' : ''); ?>">
          <a href="<?php echo e(route('login')); ?>" class="nav-link">
            <i class="material-icons">fingerprint</i> <?php echo e(__('Painel de Controle')); ?>
...
<!-- End Navbar --><?php /**PATH /var/www/escola.final/resources/views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>